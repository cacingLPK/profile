        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Kebutuhan</span>
                <?php 
                    $kebutuhan = $gaji * 0.5;
                ?>
                <span class="info-box-number">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Keinginan</span>
                <?php $keinginan=0.3*$gaji; ?>
                <span class="info-box-number">
                  <small>Rp.</small>
                  <?= $keinginan; ?>
                </span>
...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="../jsjquery.mousewheel.js"></script>
