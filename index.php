...
<html>
	...
	<meta name="author" content="Aris Krisna Marantika" />

  <!-- Facebook and Twitter integration --> 
	<meta property="og:title" content="Aris Krisna Marantika"/>
	<meta property="og:image" content="images/IMG_20190924_085507.jpg"/>
	<meta property="og:url" content="https://akm.web.id/"/>
	<meta property="og:site_name" content="Profile Aris Krisna"/>
	<meta property="og:description" content="profile aris krisna, cv aris krisna, aris krisna marantika, siapa aris krisna, it network, sysadmin, system Administrator"/>
	<meta name="twitter:title" content="Aris Krisna Marantika" />
	<meta name="twitter:image" content="images/IMG_20190924_085507.jpg" />
	<meta name="twitter:url" content="https://akm.web.id/" />
	<meta name="twitter:card" content="profile aris krisna, cv aris krisna, aris krisna marantika, siapa aris krisna, it network, sysadmin, system Administrator" />

	<link rel="canonical" href="https://akm.web.id/">
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="colorlib-main-menu" role="navigation" class="navbar">
				<div id="navbar" class="collapse">
					<ul>
						...
						<!-- <li><a href="#" data-nav-section="blog">Project</a></li>
						<li><a href="#" data-nav-section="blog">Review</a></li> -->
			...
			<div class="colorlib-footer">
				<hr>
				<p align=""><small>&copy; <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --> Copyright &copy;<script>document.write(new Date().getFullYear());</script> <!-- All rights reserved --> <br> 
				Template by <a href="https://colorlib.com/wp/template/jackson/" rel="nofollow" target="_blank">Colorlib</a><br>
				</small></p>
		...
		<div id="colorlib-main">
				   			...
				   			<div class="row">
					   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner js-fullheight">
					   					<div class="desc">
						   					<h1>Hi!</h1>
						   					<h2>Selamat datang di profile Saya</h2>
					   			...
					   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner">
					   					<div class="desc">
											...
											<h2>Silahkan kenali saya lebih jauh dengan melihat latar belakang saya.</h2>
										</div>
					   				</div>
					   			</div>
					   		</div>
							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
										<?php
											$query = mysqli_query($conn, "SELECT meta, h2, isi FROM about");
											$data = mysqli_fetch_assoc($query);
										?>
										<span class="heading-meta"><?= $data['meta']; ?></span>
										<h2 class="colorlib-heading"><?= $data['h2']; ?></h2>
										<!-- <p><strong>Aris Krisna</strong> is an ordinary person who has to learn again and again to be able to compete with smart people out there.</p>
										<p>
											He likes to work hard, giving his dedication to every workplace and work he does. He is honest in dealing with work problems, if he can't do something then he will say <i>"can't" </i>. 
											However, he is very ready to learn new things to make up for his shortcomings even if it is outside of his field of work.
										</p> -->
										<?= $data['isi']; ?>
									</div>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
							<div class="progress-wrap">
								<h3>Troubleshoot</h3>
								<div class="progress">
								 	<div class="progress-bar color-3" role="progressbar" aria-valuenow="76"
						...
						<div class="col-md-6 animate-box" data-animate-effect="fadeInRight">
							<div class="progress-wrap">
								<h3>Coding</h3>
								<div class="progress">
								 	<div class="progress-bar color-4" role="progressbar" aria-valuenow="67"
						...
						<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
							<div class="progress-wrap">
								<h3>SEO Analytics</h3>
								<div class="progress">
								 	<div class="progress-bar color-5" role="progressbar" aria-valuenow="69"
						...
						<div class="col-md-6 animate-box" data-animate-effect="fadeInRight">
							<div class="progress-wrap">
								<h3>Curiosity</h3>
								<div class="progress">
								 	<div class="progress-bar color-6" role="progressbar" aria-valuenow="89"
						...
						<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
							<div class="progress-wrap">
								<h3>Typing Speed (by: <a href="https://10fastfingers.com/typing-test/indonesian" target="_blank" rel="nofollow" >10fastfingers)</a></h3>
								<!-- <a href="https://10fastfingers.com/typing-test/indonesian"><img src="http://img.10fastfingers.com/badge/typing-test_6_BS.png" alt="Typing Test" /></a><p>Kunjungi <a href="https://10fastfingers.com/typing-test/indonesian">Tes Mengetik</a> kemudian coba!</p> -->
								<div class="progress">
								 	<div class="progress-bar color-9" role="progressbar" aria-valuenow="70"
									...
									<div class="panel panel-default">
									    <div class="panel-heading" role="tab" id="headingTwo">
									        <h4 class="panel-title">
									            <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
													Banchelor Degree in information technology</a>
									        </h4>
									    </div>
									    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
									        <div class="panel-body">
									        	<div class="row">
									        		<div class="col-md-6">
									        			<p>Budi Luhur University @ 2013-2018 <br>
									    ...
									    <div class="panel-heading" role="tab" id="headingThree">
									        <h4 class="panel-title">
									            <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
													High School In information technology</a>
									        </h4>
									    </div>
									    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
									        <div class="panel-body">
									            <div class="row">
									        		<div class="col-md-6">
									        			<p>
									        				SMK Media Informatika @ 2010-2013<br>
							 ...
							 <article class="timeline-entry animate-box" data-animate-effect="fadeInLeft">
								   <div class="timeline-entry-inner">
									  ...
									  <div class="timeline-label">
										  <h2><a href="#">System Administrator at <b>PANDI</b></a> <span>09 Mei 2020 - Now (<?= $tpandidiff->format('Usia anda adalah %Y tahun %m bulan %d hari'); ?>)</span></h2>
										 <p>
								   ...
								   <div class="timeline-entry-inner">
									  ...
									  <div class="timeline-label">
										 ...
										 <p>
											 <strong>Jobdesk:</strong><br>
											 <ul>
												 <li>Optimizing the Company's website, and the Company's Client's website in terms of content and onpage SEO optimization.</li>
												 <li>Assist the SEO Team in handling technical Linux Server problems.</li>
											 </ul>
										 </p>
									  </div>
								   </div>
					            ...
					            <div class="timeline-entry-inner">
					               ...
					               <div class="timeline-label">
					                  ...
					                  <p>
										<strong>Jobdesk:</strong><br>
										<ul>
											<li>Handling user complaints for each division.</li>
											<li>Ensure that the printer device is running properly.</li>
											<li>Make suer the email service is running well.</li>
											<li>Monitoring CCTV equipment to run well and had several times to repair cable lines.</li>
											<li>Support to a group of companies, namely PT Telesindo Media Indonesia to participate in the Korlantas Polri SBST Project.</li>
										</ul>
					                  </p>
					               </div>
					            </div>
					            ...
					            <div class="timeline-entry-inner">
					               ...
					               <div class="timeline-label">
					                  ...
					                  <p>
										<strong>Jobdesk:</strong><br>
										<ul>
											<li>Assemble, install, maintain PC users.</li>
											<li>Cloning OS with Northon Ghost installed on WinPE using Upanok bootable.</li>
											<li>Desigh the topology, installation, manage, and maintenance of the network for user needs.</li>
											<li>Point to point network maintenance with ubiquiti device.</li>
											<li>Assemble, install, maintain PC game servers for game distribution to clients.</li>
											<li>Design, install, and monitor CCTV devices to run properly.</li>
										</ul>
					                  </p>
					               </div>
					            </div>
					            ...
					            <div class="timeline-entry-inner">
								   ...
								   <div class="timeline-label">
									   ...
									   <p>
										   ...
										   <ul>
											   <li>Troubleshooting about PC problems in the computer lab.</li>
											   <li>Troubleshooting about network problems in the computer lab.</li>
											   <li>Assemble a new PC if needed.</li>
											   <li>Become a supervisory committee for the Expertise Competency Test at SMK Media Informatika.</li>
										   </ul>
									   </p>
								   </div>
					            </div>
			...
			<section class="colorlib-blog" data-section="blog">
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
							<span class="heading-meta">A MEDIUM TO REMEMBER</span>
					...
					<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
						<div class="col-md-12">
							<div class="about-desc">
								<p>
									Sometimes I also on several occasions write on a blog that I manage myself. 
									If I'm not mistaken, I created this blog in 2019.
								</p>
								<p>
									The reason behind the creation of this blog is to continue my previous blog which uses a free domain. 
									In addition, this blog also has a purpose as my notebook. 
									Yes, the fact is that I have a bad habit of forgetting easily. 
									It's easy for me to forget something I don't do regularly.
								</p>
								<p>
									Then I also intend to share this blog with others about my work and field experiences. 
									I'm sure there may be some people out there who have a hard-to-remember like me. 
									Hopefully this blog can be a solution for them.
								</p>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-4 animate-box">
								<p><a href="https://akm.web.id/blog/" target="_blank" class="btn btn-primary btn-lg btn-load-more">Read More <i class="icon-reload"></i></a></p>
							</div>
							<div class="col-md-4 animate-box"></div>
						</div>
					</div>
			...
			<!-- <section class="colorlib-contact" data-section="project">
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
							<span class="heading-meta">My Projects</span>
							<h2 class="colorlib-heading">Project</h2>
						</div>
					</div>
				</div>
			</section>

			<section class="colorlib-contact" data-section="review">
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
							<span class="heading-meta">My Reviews</span>
			...
			<section class="colorlib-contact" data-section="contact">
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
							<span class="heading-meta">CONNECT WITH ME</span>
						...
						<div class="col-md-5">
							<div class="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="colorlib-text">
									<p><a href="mailto:aris.krishna17@gmail.com">aris.krishna17@gmail.com</a></p>
								</div>
							</div>
							...
							<div class="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="colorlib-text">
									<p><a href="https://www.linkedin.com/in/cacinglpk">Aris Krisna Marantika</a></p>
								</div>
							</div>
						</div>
